		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-5">
					...
					<div class="company_intro">
						...
						<br><br><br><br><br>
							...
							<p class="brand_intro3">전문가의 경험을 살린 각 분야 전문 노하우, 알짜배기 팁까지</p>
				...
				<div class="col-lg-7" style="text-align:right;">
					<!--  이미지 시작 -->
					<img src="${pageContext.request.contextPath}/front/brandintro_1.png"	id="BrandImg" alt="Brand img">	
				</div>
