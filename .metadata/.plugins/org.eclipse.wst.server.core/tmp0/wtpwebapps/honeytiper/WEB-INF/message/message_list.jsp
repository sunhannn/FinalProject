...
// 					send_msg += "			<textarea class='write_msg form-control' maxlength='800' placeholder='&nbsp;메세지를 입력해주세요.&#13;&#10;&nbsp;800자까지 전송 가능합니다.'></textarea>";
// 					send_msg += "		</div>";
...
// 					send_msg += "</div>";
					...
					// 메세지 내용을 불러오는 함수 호출
					MessageContentList(message_room, send_btn);
	...
	// 메세지 리스트를 다시 가져온다.
	const MessageList = function(send_btn){
		$.ajax({
			url:"message_ajax_list.do",
			method:"get",
			data:{
	...
	const MessageContentList = function(message_room, send_btn) {
	...
	const SendMessage = function(message_room, other_user_id, send_btn){
		...
		//alert("message_cont: " + message_cont);
