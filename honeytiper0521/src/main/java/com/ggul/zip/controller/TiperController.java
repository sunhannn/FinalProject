...
public class TiperController {
	...
	public void lessonDelete(Model model, HttpServletResponse response, HttpServletRequest request, HttpSession session,
		...
		int check = lessonService.escrowCheckDelete(lessonVO);
	...
	public void tiperReportLessonNum(Model model, ReportVO vo, HttpServletResponse response, LessonVO lessonVO)
			throws Exception {
