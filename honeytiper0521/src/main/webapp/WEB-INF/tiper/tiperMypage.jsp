			...
			<table id="mob-tab">
				<tr id="mob-pro-tr1">
					...
					<td id="mob-pro-td3"><span id="mob-pay-sub">My허니페이<br>
						<br>
						<span id="mob-point"><fmt:formatNumber value="<%=point%>" /></span><span
							class="mob-point2">&nbsp;허니페이</span>
					</span></td>
				</tr>
			...
			<table id="mytip_tabpro">
				<tr id="mytip_trpro">
					...
					<td id="mytip_tdpro2"><p id="mytip_point2">
							<span id="mytip_point3">My허니페이<br>
							<br>
							<span id="mytip_pointspan"><fmt:formatNumber
										value="<%=point%>" /></span> <span class="honey_pay"> 허니페이</span>
							</span><br>
