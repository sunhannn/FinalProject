...
function displayData(currentPage, dataPerPage, dataList) {
	...
	if(endPage > (dataList.length)) endPage = dataList.length;
	 ...
	 for (var i = startPage ;i < endPage; i++){
		 chartHtml += "<tr onclick='selTr("+dataList[i].notice_num +")' style='cursor: pointer'><td>" + dataList[i].notice_num + "</td><td>" + dataList[i].notice_title + "</td><td>"+dataList[i].notice_date+"</tr>";
	 }
...
<body>
        <img src="${pageContext.request.contextPath}/front/LOGO.png" alt="로고이미지" title="로고이미지" id="logo">
        <div class="container">
            <hr class="hrFirst">
            <div class="divLeft">
