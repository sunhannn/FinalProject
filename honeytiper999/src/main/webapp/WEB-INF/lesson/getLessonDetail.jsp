...
.input-group-prepend .cont1-group-title{
...
.input-group-prepend #cont1-group-title-img{
	background-color: white !important;
	font-weight: bold !important;
	width: 120px;
	height: 100px;
...
.input-group-prepend #cont1-group-title-img img{
	vertical-align: middle;
	width: 80px;
	height: 80px;
}
...
<script> 
  ...
  $.ajax({ // ajax로 데이터 가져오기
 	...
 	success: function (d) {
        ...
        //데이터 대입
        dataList=d;
        console.log("ajax안에서"+JSON.stringify(dataList));
 		 }
  });		
 ...
 //현재 페이지(currentPage)와 페이지당 글 개수(dataPerPage) 반영
  ...
  //Number로 변환하지 않으면 아래에서 +를 할 경우 스트링 결합이 되어버림.. 
   ...
   if (totalData < (currentPage - 1) * dataPerPage + dataPerPage){
	...
	console.log("if 나가기전 chartHtml" + chartHtml);
...
<%-- 	<input type="text" name="tiper_img" id="tiper_img" 	value="${lessonDetail.tiper_img}"> --%>

		<div id="contbox0">
			<c:if test="${lessonDetail.lesson_cate eq 'IT' }"><img src="${pageContext.request.contextPath}/front/ITdefault.jpg" alt="IT카테고리"></c:if>
			<c:if test="${lessonDetail.lesson_cate eq '예체능' }"><img src="${pageContext.request.contextPath}/front/Musicdefault.jpg" alt="예체능카테고리"></c:if>
			<c:if test="${lessonDetail.lesson_cate eq '공예' }"><img src="${pageContext.request.contextPath}/front/ITdefault.jpg" alt="공예카테고리"></c:if>
			<c:if test="${lessonDetail.lesson_cate eq '사무' }"><img src="${pageContext.request.contextPath}/front/ITdefault.jpg" alt="사무카테고리"></c:if>
			<c:if test="${lessonDetail.lesson_cate eq '라이프스타일' }"><img src="${pageContext.request.contextPath}/front/ITdefault.jpg" alt="라이프스타일카테고리"></c:if>
		</div>


			<div id="contbox1">
			<div class="profile_img_box">
			<img src="${pageContext.request.contextPath}/front/${lessonDetail.tiper_img}" alt="기본이미지" />
			</div>
			...
			<div id="contbox1_text">
				...
				<div class="cont1 mb-3">
					...
					<span class="cont1-group-title" id="cont1-group-text">@${lessonDetail.tiper_user_id}</span>
				</div>

					<div id="button_box"><button type="button" id="msg_button">쪽지</button></div>
				</div>	
		...
		<div id="contbox2">
			...
			<div class="cont2 mb-3">
				<div class="input-group-prepend">
					<div class="cont1-group-title" id="cont1-group-title-img"><img src="${pageContext.request.contextPath}/front/sugar.png"></div> 
					<div class="cont1-group-text">
					<c:if test="${sugarAvg eq 98.98 }"><c:out value="평점이 없어요!" /></c:if>
					<c:if test="${sugarAvg ne 98.98 }"><c:out value="${sugarAvg}/5점" /></c:if>
					</div> 
				</div>
			</div>
			</div>
	...
	<div id="contbox3_titleholder">
		<a href="#tiperinfo_h4">강사정보</a>
		<a href="#lessoninfo_h4">강의정보</a>
		<a href="#review_h4">리뷰</a>
	</div>

		<span class="anchor" id="tiperinfo_h4"></span>	
		<h4>강사정보</h4>
		<div><pre>${lessonDetail.tiper_info}</pre> </div><br> <br>

		<span class="anchor" id="lessoninfo_h4"></span>	
		<h4>강의정보</h4>
		<div><pre>${lessonDetail.lesson_info}</pre></div><br> <br>

		<span class="anchor" id="review_h4"></span>	
		<h4>리뷰</h4>
