...
<body>
		...
		<table>
			<c:forEach items="${lessonList}" var="lesson">
				<tr id="mytab_tr">
					...
					<td id="mytab_5"><img src="front/siren.png" alt="신고"
						class="fileModal_singo" onclick="hsh2(${lesson.lesson_num})"
						id="myimg_singo"></td>
				</tr>
	...
	<!-- 신고하기 모달창  -->
	<div class="modal" id="modalSingo">
		<div class="modal-window-singo">
			<div id="modal-title-singo">
				<h3>신고 하기</h3>
			</div>

			<div class="modal-content-singo">

				<div id="text_container-singo">

					<span class="rev_span">신고를 하시기 전에!</span> <br> <span
						class="rev_span">한번 더 생각 해주세요!</span> <br> <span
						class="rev_span">허위 신고를 할 경우</span> <br> <br> <span
						class="rev_span">그 사람에게 큰 상처가 될 수 있습니다.</span>

				</div>

				<br>

				<form action="singoAction" method="get">

					<div id="user_singo1">
						<input type="text" placeholder="신고내용을 입력해주세요!" id="singo_input1"
							name="report_cont"> <input type="hidden"
							name="review_lesson_num" id="lessonNum_singo">
					</div>
			</div>
	...
	<script>
    	...
    	const btnModalCloseSingo = document.querySelector('#btn_close_singo');
    		...
    		function hsh2(val) {
    			modal.style.display='block';
    	        document.body.style.overflow = 'hidden';
    	       	document.getElementById("lessonNum_singo").value = val;
			}
    	...
    	// 신고창 닫기
    	btnModalCloseSingo.addEventListener('click', () => {
        	modal.style.display='none';
        	});
