...
for (var i = startPage; i < endPage; i++) {
    ...
    var formattedEscrowEnd = formatDate(dataList[i].notice_end) || "";
	 ...
	 chartHtml += "<tr onclick='selTr("+dataList[i].notice_num +")' style='cursor: pointer'><td  style='width:15%; text-overflow:ellipsis; overflow:hidden; white-space:nowrap;'>" +(dataList[i].notice_title || "") + "</td><td style='width:35%; text-overflow:ellipsis; overflow:hidden; white-space:nowrap;'>" + (dataList[i].notice_cont || "") + "</td><td>" + (dataList[i].notice_date || "") +
