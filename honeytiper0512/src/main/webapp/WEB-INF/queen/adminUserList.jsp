...
<div id="container003">
  <div id="table003">
   <h2 style="margin:40px 0px;">회원리스트</h2>
               <hr class="hrFirst">
        <div id="search_wrapper">
     <select class="form-control" id="sel1" name="user_condition" style="display:inline-block!important;margin-right:10px;">

      <option value="user_id">아이디</option>
      <option value="user_name">이름</option>
    </select>
    
    <input class="form-control mr-sm-2" type="text" name="user_search" id="sel2" placeholder="검색어를 입력하세요.">
<!--     <button class="btn btn-success" type="submit" id="sel3">검색</button> -->
...
<%--    <tr onclick="selTr(${user.user_id})" style="cursor:pointer;"> --%>
<%--      <td class="tdCenter">${user.user_name}</td> --%>
<%--      <td>${user.user_addr1}${user.user_addr2}${user.user_addr3}${user.user_addr4}</td> --%>
<%--      <td class="tdCenter">${user.user_tel}</td> --%>
<%--      <td class="tdCenter">${user.user_email}</td> --%>
<%--      <td class="tdCenter">${user.user_cate}</td> --%>
<!--    </tr> -->
<%-- </c:forEach> --%>
    </tbody>
  </table><br><br>
      ...
      var i = (currentPage - 1) * dataPerPage;
          i < totalData;
              ...
              chartHtml +=
                ...
                "</td><td>" +
                (dataList[i].user_addr1 +  dataList[i].user_addr2 +  dataList[i].user_addr3 + dataList[i].user_addr4)+
                "</td><td>" +
                (dataList[i].user_tel  || "") +
                "</td><td>" +
