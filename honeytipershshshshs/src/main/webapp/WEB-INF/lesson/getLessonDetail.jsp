...
<%-- 				<img src="${pageContext.request.contextPath}/front/ITdefault.jpg" alt="IT카테고리"> --%>
				<picture>
    				<source srcset="${pageContext.request.contextPath}/front/ITdefault768.jpg" media="(max-width: 768px)">
    				<img src="${pageContext.request.contextPath}/front/ITdefault.jpg" alt="IT카테고리"/>
				</picture>
			</c:if>
...
<%-- 				<img src="${pageContext.request.contextPath}/front/Musicdefault.jpg" alt="예체능카테고리"> --%>
				<picture>
    				<source srcset="${pageContext.request.contextPath}/front/Musicdefault768.jpg" media="(max-width: 768px)">
    				<img src="${pageContext.request.contextPath}/front/Musicdefault.jpg" alt="예체능카테고리"/>
				</picture>
			</c:if>
			<c:if test="${lessonDetail.lesson_cate eq '공예' }">
<%-- 				<img src="${pageContext.request.contextPath}/front/Craftdefault.jpg" alt="공예카테고리"> --%>
					<source srcset="${pageContext.request.contextPath}/front/Craftdefault768.jpg" media="(max-width: 768px)">
    				<img src="${pageContext.request.contextPath}/front/Craftdefault.jpg" alt="공예카테고리"/>
...
<%-- 				<img src="${pageContext.request.contextPath}/front/Officedefault.jpg" alt="사무카테고리"> --%>
					<picture>
    				<source srcset="${pageContext.request.contextPath}/front/Officedefault768.jpg" media="(max-width: 768px)">
    				<img src="${pageContext.request.contextPath}/front/Officedefault.jpg" alt="사무카테고리"/>
				</picture>
			</c:if>
...
<%-- 				<img src="${pageContext.request.contextPath}/front/Lifestyledefault.jpg" alt="라이프스타일카테고리"> --%>
				<picture>
    				<source srcset="${pageContext.request.contextPath}/front/Lifestyledefault768.jpg" media="(max-width: 768px)">
    				<img src="${pageContext.request.contextPath}/front/Lifestyledefault.jpg" alt="라이프스타일카테고리"/>
				</picture>
			</c:if>
		</div>
