...
<script>
 ...
 function displayData(currentPage, dataPerPage) {
  ...
  //Number로 변환하지 않으면 아래에서 +를 할 경우 스트링 결합이 되어버림.. 
       ...
       var i = (currentPage - 1) * dataPerPage;
           i < totalData;
               ...
               chartHtml +=            
                  ...
                  '<img class="ImgBorder" src="${pageContext.request.contextPath}/front/lesson/' + dataList[i].lesson_img + '"></a></td>' +
                  '<td class="tdCenter1">' + '<span class="bold-text">[ ' + dataList[i].lesson_cate + ' ] </span>' + '<br>' +
                  '<a href="getLessonDetail?lesson_num=' + dataList[i].lesson_num + '">' + dataList[i].lesson_title + '</a><br>' + dataList[i].lesson_user_name + '</td>' +
                  ...
                  '<button class="lessonDetail" onclick="location.href=\'getLessonDetail?lesson_num=' + dataList[i].lesson_num + '\'">관심있어요</button></td>'+
                  '</tr>' +
                  '<style>' +
   ...
   if( typeof chartHtml == "undefined" || chartHtml == ''){ chartHtml +=" <class='if_undefined'><span>클래스 목록이 없습니다.<span></div>"}
